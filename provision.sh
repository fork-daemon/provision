...
apt-get install -y curl mc htop dos2unix unzip vim grc gcc make re2c libpcre3 libpcre3-dev lsb-core autoconf > /dev/null
...
# #############
# echo "# MySQL with root:<no password>" 
